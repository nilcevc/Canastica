    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**").allowedOrigins("http://localhost:3000","https://canastica.azurewebsites.net", "https://canastica.onrender.com").allowCredentials(true).allowedMethods("GET","POST","DELETE");
            }
        };
    }
}
